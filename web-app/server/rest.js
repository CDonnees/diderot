...
Api.addRoute('answer/:id', {}, {
  get() {
    ...
    if (answer) {
      ...
      return  `<!doctype html><html lang="fr"><head><meta charset="utf-8"><meta property='twitter:card', content='summary_large_image'/><meta property='twitter:site', content='@Diderotbot'/><meta property='twitter:creator', content='@Diderotbot'/><meta property='twitter:title', content='${htmlEscape(search.originalTags.join(', '))} sur le Diderobot !'/><meta property='twitter:description', content='${htmlEscape(answer.text || answer.title)}'/><meta name='twitter:image' content='${htmlEscape(answer.finalImage)}'/><meta property='twitter:url', content='${Meteor.absoluteUrl()}api/answer/${answer._id}'/></head><body><script type="text/javascript"> window.setTimeout(function() {window.location="${htmlEscape(answer.resourceUrl)}"}, 300);</script></body></html>`;
    }
  },
});
